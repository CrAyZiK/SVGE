...
namespace SimpleVectorGraphicsEditor
{
    ...
    {
        private Polygon(Point origin, Point offset)
        {
        ...
        public class PolygonCreator : Creator
        {
            public override Figure Create(Point location, Point offset)
            {
                return new Polygon(location, offset);
            }

        }
        public class PolygonVisualizer : ToolVisualizer
        {
