...
namespace SimpleVectorGraphicsEditor
{
    public partial class FormMain : Form
    {
        ...
        private const string Title = @"Простой векторный графический редактор";

        private Dictionary<String, EditorMode> tagToMode = new Dictionary<String, EditorMode>
        {
            { "Selection", EditorMode.Selection},
            { "AddLine", EditorMode.AddLine},
            { "AddPolygon", EditorMode.AddPolygon},
            { "AddRectangle", EditorMode.AddRectangle},
            { "AddSquare", EditorMode.AddSquare},
            { "AddEllipse", EditorMode.AddEllipse},
            { "AddCircle", EditorMode.AddCircle}
        };
        ...
        private void tsbSelectMode_Click(object sender, EventArgs e)
        {
            ...
            //}
            _editor.EditorMode = tagToMode[button.Tag.ToString()];
