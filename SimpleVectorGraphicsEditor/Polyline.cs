...
namespace SimpleVectorGraphicsEditor
{
    ...
    {
        private Polyline(Point origin, Point offset)
        {
        ...
        public class LineCreator : Creator 
        {
            ...
            {
                return new Polyline(location, offset);
            }

        }
        public class LineVisualizer : ToolVisualizer
        {
            public override void Draw(Graphics graphics, Point location, Point location2)
            {
                graphics.DrawLine(new Pen(Color.Black) { DashStyle = DashStyle.Solid }, location, location+(Size)location2);
            }
        }
    }
}
