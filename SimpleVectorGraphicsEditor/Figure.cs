...
{
    public enum FigureInteractionMod {
        None,
        Dragging,
        Resizing,
        VertexEditing
    ...
    {
        public abstract Figure Create(Point location, Point offset);
    }
    public abstract class ToolVisualizer
    {
        public abstract void Draw(Graphics graphics, Point location, Point location2);
    }
    public class SelectionVisualizer :ToolVisualizer
    {
        public override void Draw(Graphics graphics, Point location, Point location2)
        {
            graphics.DrawRectangle(new Pen(Color.Black) { DashStyle = DashStyle.Dot }, new Rectangle(location, (Size)location2));
        }
    }
    public interface IVertexSupport
    {
        List<Marker> CreateVertexMarkers();
    ...
    public abstract class Figure: ICloneable
    {
        ...
        public readonly List<Marker> VertexMarkers = new List<Marker>();
...
// ReSharper disable UnusedParameter.Local
        ...
        public virtual void UpdateLocation(PointF offset, RectangleF oldrect, RectangleF newrect)
        {
            // перемещение фигуры
            var pts = GetPoints();
        ...
        public virtual void UpdateSize(PointF offset, RectangleF oldrect, RectangleF newrect, Marker marker)
        {
            PointF[] pts;
        ...
        //move into manipulator
        //public abstract List<Marker> CreateSizeMarkers();
        ...
        /// <param name="marker">индекс маркера</param>
        public virtual void DrawFocusFigure(Graphics graphics, PointF offset, RectangleF oldrect, RectangleF newrect, Marker marker)
        {
            if (marker == null)
            {
                using (var gp = new GraphicsPath())
        ...
        public abstract void AddFigureToGraphicsPath(GraphicsPath gp);
