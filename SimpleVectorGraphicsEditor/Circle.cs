...
namespace SimpleVectorGraphicsEditor
{
    ...
    public class Circle : Oval
    {
        ...
        private Circle(Point origin, Point offset)
        ...
        public class CircleCreator : Creator
        {
            ...
            {
                return new Circle(location, offset);
            }

        }
        public class CircleVisualizer : ToolVisualizer
        {
            public override void Draw(Graphics graphics, Point location, Point location2)
            {
                ...
                graphics.FillEllipse(Brushes.White, _rect);
                graphics.DrawEllipse(new Pen(Color.Black) { DashStyle = DashStyle.Solid }, _rect);
            }
        }
    }
}
